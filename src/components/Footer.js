        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Connect talented professionals with amazing opportunities. Find your dream job or hire the perfect candidate for your team.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="https://about.jobboard.com" className="text-gray-300 hover:text-white transition-colors">
                  About Us
                </a>
              </li>
            </ul>
